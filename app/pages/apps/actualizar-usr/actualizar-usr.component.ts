...
@Component({
  selector: 'app-actualizar-usr',
  templateUrl: './actualizar-usr.component.html',
  styleUrls: ['./actualizar-usr.component.scss']
})

export class ActualizarUsrComponent implements OnInit {
  form: FormGroup;
  usuarios: any= [];

  public Id: '';
  public Usuario: string | undefined | null = null;
  public IdrolUsr: string | undefined | null = null;
  public Roles: any[] = [];
      ...
      this.adminUsr.getUsuarioId(this.Id).subscribe((data) => {
        //  console.log(data)
          if (data.ok) {
            ...
            this.IdrolUsr =this.usuarios[0].pIdRol
            console.log(this.IdrolUsr)
          }
        });
